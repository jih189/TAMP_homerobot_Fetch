...
class ExperienceGraph
{
    ...
    using VertexPropertyType = boost::property<boost::vertex_index_t, long unsigned int,
                               ...
                               boost::property<vertex_constraint_id_t, int,
                               boost::property<vertex_node_id_t, int>>>>;
    ...
    boost::property_map<GraphType, vertex_node_id_t>::type vertex_node_id_map;
    boost::property_map<GraphType, boost::edge_weight_t>::type edge_weight_map;

    std::unordered_map<VertexKey, Vertex, pair_hash> vertex_map;
    ...
    Vertex addVertex(const std::vector<double>& jointstate, const int& constraint_id, const int& node_id);
    bool hasVertex(const int& constraint_id, const int& node_id);
    Vertex getVertex(const int& constraint_id, const int& node_id);
