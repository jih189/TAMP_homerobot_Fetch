...
private:
    ...
    /*!
     * \brief Callback for search the table.
     *
     * Search the table area and return the table height.
     *
     * \param req The empty request.
     * \param res The height.
     * \return Returns true if a valid index was provided.
     */
    bool searchTableCallback(rail_segmentation::SearchTable::Request &req,
        rail_segmentation::SearchTable::Response &res);
    ...
    */
    ...
    ros::ServiceServer segment_srv_, segment_objects_srv_, segment_objects_from_point_cloud_srv_, clear_srv_, remove_object_srv_, search_table_srv_, calculate_features_srv_;
