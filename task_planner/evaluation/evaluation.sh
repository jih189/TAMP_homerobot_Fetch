...
DOCKER_NAME_PREFIX="manipulation_apr5_sup" # assign a unique prefix for each docker container
IMAGE_NAME="rss2024_rebuttal_exp:apr5_supp" # image name for the evaluation container you commited before
