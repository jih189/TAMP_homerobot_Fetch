...
GMM_NAME="dpgmm_6dof_275" # dpgmm_7dof_262 | dpgmm_6dof_443 | dpgmm_6dof_186 | dpgmm_7dof_1310

DOCKER_NAME_PREFIX="manipulation_apr9_ur5_275" # assign a unique prefix for each docker container
IMAGE_NAME="rss2024_rebuttal_exp:apr9_v3" # image name for the evaluation container you commited before
