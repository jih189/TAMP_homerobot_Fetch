...
EXP_NAME="CONS_EXP" # the name of the experiment, this will shown in the results script
...
DOCKER_NAME_PREFIX="manipulation_fetch_apr10_exp" # assign a unique prefix for each docker container
IMAGE_NAME="rss2024_rebuttal_exp:apr10_v2" # image name for the evaluation container you commited before
