...
EXP_NAME="FinalStage_Eval_Fetch" # the name of the experiment, this will shown in the results script

MODEL_NAME="FETCH" # FETCH | UR5
MOVEIT_CONFIG="fetch_moveit_config" # fetch_moveit_config | ur5_moveit_config
GMM_NAME="dpgmm_7dof_1310" # dpgmm_7dof_262 | dpgmm_6dof_443 | dpgmm_7dof_1310

DOCKER_NAME_PREFIX="manipulation_fetch_apr10_1310" # assign a unique prefix for each docker container
IMAGE_NAME="rss2024_rebuttal_exp:apr10" # image name for the evaluation container you commited before
