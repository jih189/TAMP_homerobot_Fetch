...
if __name__ == "__main__":
    ...
    for g in grasp_pose_list:
        ...
        table_top_pose = np.array([[1, 0, 0, 0.44],
                                    [0, 1, 0, 0],
                                    [0, 0, 1, 0.83],
                                    [0, 0, 0, 1]])
        ...
        for intersection_motion in intersections_from_grasp_to_post_grasp:
            intersection = Intersection(1,current_grasp_manifold_id,2,0, False, intersection_motion, numpify(target_cup_pose.pose), package_path + '/mesh_dir/cup.stl', "cup")
            experiment.add_intersection(intersection)
