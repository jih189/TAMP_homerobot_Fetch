...
if __name__ == "__main__":
    ...
    for placement_manifold in placement_pose_manifolds:
        for grasp_manifold in grasp_pose_manifolds:
            ...
            grasp_pose_mat = np.dot(placement_manifold.object_pose, grasp_manifold.in_hand_pose)
            ...
            for _ in range(10):
                ...
                intersection_motion = np.array([p.positions for p in approach_plan.joint_trajectory.points])
