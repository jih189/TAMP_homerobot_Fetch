...
class MTGTaskPlannerWithAtlas(BaseTaskPlanner):
    ...
    def update(self, task_graph_info_, plan_, manifold_constraint_):
        ...
        for n in self.task_graph.nodes():
            ...
            weight_value =  (1 - beta_value) * (arm_env_collision_score_before_project + path_constraint_violation_score_before_project + obj_env_collision_score_before_project ) + beta_value * (arm_env_collision_score_after_project + obj_env_collision_score_after_project)
